...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vo(e,t,n){return new Yi({name:`SphericalGaussianBlur`,defines:{SAMPLES:Eo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ho(){return new Yi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Uo(){return new Yi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Wo(),fragmentShader:`
	...
	`}var Go=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ai(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var gc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function _c(e,t){let n=gc[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var vc=new G;function yc(){return q.getLuminanceCoefficients(vc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${vc.x.toFixed(4)}, ${vc.y.toFixed(4)}, ${vc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=cc(i,i.VERTEX_SHADER,y),S=cc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=mc(i,x,`vertex`),n=mc(i,S,`fragment`);H(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Yl=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Xl=new Ba(-1,1,1,-1,0,1),Zl=new class extends Er{constructor(){super(),this.setAttribute(`position`,new mr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new mr([0,2,0,0,2,0],2))}},Ql=class{constructor(e){this._mesh=new Xr(Zl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Xl)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},$l=class extends Yl{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Yi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ki.clone(e.uniforms),this.material=new Yi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Ql(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},eu=class extends Yl{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},tu=class extends Yl{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},nu=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new W);this._width=n.width,this._height=n.height,t=new Kt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new $l(Jl),this.copyPass.material.blending=0,this.timer=new Ga}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}eu!==void 0&&(r instanceof eu?n=!0:r instanceof tu&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new W);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},ru=class extends Yl{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new J}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},iu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new J(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},au=class e extends Yl{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new W(256,256):new W(e.x,e.y),this.clearColor=new J(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Kt(i,a,{type:_,depthBuffer:!1}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Kt(i,a,{type:_,depthBuffer:!1});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Kt(i,a,{type:_,depthBuffer:!1});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=iu;this.highPassUniforms=Ki.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new Yi({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new W(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new G(1,1,1),new G(1,1,1),new G(1,1,1),new G(1,1,1),new G(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Ki.clone(Jl.uniforms),this.blendMaterial=new Yi({uniforms:this.copyUniforms,vertexShader:Jl.vertexShader,fragmentShader:Jl.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new J,this._oldClearAlpha=1,this._basic=new Rr,this._fsQuad=new Ql(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new W(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);let r=[],i=[];for(let n=1;n<e;n+=2){let a=t[n],o=n+1<e?t[n+1]:0,s=a+o;r.push((n*a+(n+1)*o)/s),i.push(s)}return new Yi({defines:{KERNEL_PAIRS:r.length},uniforms:{colorTexture:{value:null},invSize:{value:new W(.5,.5)},direction:{value:new W(.5,.5)},centerWeight:{value:t[0]},gaussianOffsets:{value:r},gaussianWeights:{value:i}},vertexShader:`
				...
				}`})}_getCompositeMaterial(e){return new Yi({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}};au.BlurDirectionX=new W(1,0),au.BlurDirectionY=new W(0,1);var ou={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},su=class extends Yl{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ki.clone(ou.uniforms),this.material=new Xi({name:ou.name,uniforms:this.uniforms,vertexShader:ou.vertexShader,fragmentShader:ou.fragmentShader}),this._fsQuad=new Ql(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},q.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},cu=class{constructor(e,t,n,r={}){this.renderer=e,this.composer=new nu(e),this.renderPass=new ru(t,n),this.composer.addPass(this.renderPass),this.bloomPass=new au(new W(window.innerWidth,window.innerHeight),r.strength??.62,r.radius??.45,r.threshold??.72),this.composer.addPass(this.bloomPass),this.outputPass=new su,this.composer.addPass(this.outputPass),this.setBloomEnabled(r.bloom??!0),this.setSize(window.innerWidth,window.innerHeight)}setBloomEnabled(e){this.bloomPass.enabled=e}get bloomEnabled(){return this.bloomPass.enabled}setBloomStrength(e){this.bloomPass.strength=e}setSize(e,t){this.composer.setSize(e,t),this.bloomPass.setSize(e,t)}render(e){this.composer.render(e)}dispose(){this.composer.dispose?.(),this.bloomPass.dispose?.()}},lu=Math.PI/180,uu=180/Math.PI;function du(e){return e.getTime()/864e5+2440587.5}function fu(e){return(du(e)-2451545)/36525}function pu(e){return e-360*Math.floor(e/360+.5)}function mu(e,t,n=1e-10,r=40){let i=t<.8?e:Math.PI;for(let a=0;a<r;a++){let r=(i-t*Math.sin(i)-e)/(1-t*Math.cos(i));if(i-=r,Math.abs(r)<n)break}return i}function hu(e,t){let n=e.a+(e.aDot??0)*t,r=e.e+(e.eDot??0)*t,i=(e.I+(e.IDot??0)*t)*lu,a=e.L+(e.LDot??0)*t,o=e.peri+(e.periDot??0)*t,s=(e.node+(e.nodeDot??0)*t)*lu,c=pu(a-o)*lu,l=o*lu-s,u=mu(c,r),d=Math.cos(u),f=Math.sin(u),p=Math.sqrt(1-r*r),m=n*(d-r),h=n*p*f,g=Math.cos(l),_=Math.sin(l),v=Math.cos(s),y=Math.sin(s),b=Math.cos(i),x=Math.sin(i),S=(g*v-_*y*b)*m+(-_*v-g*y*b)*h,C=(g*y+_*v*b)*m+(-_*y+g*v*b)*h,w=_*x*m+g*x*h;return{x:S,y:C,z:w,r:Math.hypot(S,C,w),a:n,e:r,meanAnomaly:c*uu,eccentricAnomaly:u,trueAnomaly:Math.atan2(h,m)*uu}}function gu(e){return 280.46061837+360.98564736629*(e-2451545)}function _u(e,t,n,r={x:0,y:0,z:0}){return r.x=e,r.y=n,r.z=-t,r}function vu(e,t,n,r={x:0,y:0,z:0}){let i=hu(e,t),a=n(i.a),o=i.r>0?a/i.r:0;return _u(i.x*o,i.y*o,i.z*o,r)}var yu=[{label:`Berhenti`,daysPerSecond:0},{label:`1 jam / detik`,daysPerSecond:1/24},{label:`2,4 jam / detik`,daysPerSecond:.1},{label:`1 hari / detik`,daysPerSecond:1},{label:`10 hari / detik`,daysPerSecond:10}],bu=class{constructor(e=new Date){this.startJulian=du(e),this.startDate=new Date(e.getTime()),this.elapsedDays=0,this.daysPerSecond=.1,this.paused=!1,this.elapsedSeconds=0}get date(){return new Date((this.startJulian+this.elapsedDays-2440587.5)*864e5)}get julian(){return this.startJulian+this.elapsedDays}get centuries(){return fu(this.date)}get elapsedHours(){return this.elapsedDays*24}update(e){if(this.elapsedSeconds+=e,!this.paused){let t=Math.min(e,.25)*this.daysPerSecond;this.elapsedDays+=t}}setSpeed(e){this.daysPerSecond=Math.max(0,e)}reset(){this.elapsedDays=0}},xu={low:{label:`Rendah`,pixelRatio:1,sphereSegments:{planet:64,moon:32,sun:64},anisotropy:2,starCount:1800,asteroids:700,kuiper:400,bloom:!1,heroTextures:!1,atmosphereLayers:1,shadows:!1},medium:{label:`Sedang`,pixelRatio:1.35,sphereSegments:{planet:96,moon:40,sun:96},anisotropy:4,starCount:3200,asteroids:1800,kuiper:900,bloom:!0,heroTextures:!1,atmosphereLayers:2,shadows:!0},high:{label:`Tinggi`,pixelRatio:1.75,sphereSegments:{planet:160,moon:56,sun:128},anisotropy:8,starCount:4500,asteroids:3600,kuiper:2200,bloom:!0,heroTextures:!0,atmosphereLayers:2,shadows:!0}};function Su(e){if(typeof navigator>`u`)return`medium`;let t=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent),n=navigator.hardwareConcurrency??4,r=navigator.deviceMemory??4,i=e?.capabilities?.maxTextureSize??4096;return t||n<=2||r<=2?`low`:n<=4||i<8192?`medium`:`high`}function Cu(e,t){let n=[`low`,`medium`,`high`],r=n.indexOf(e);return t<26&&r>0?n[r-1]:e}function wu(e,t){return t.heroTextures?(e?.capabilities?.maxTextureSize??0)>=8192:!1}function Tu(e,t={}){let n=new kl({canvas:e,antialias:t.antialias??!0,alpha:!1,stencil:!1,powerPreference:`high-performance`,failIfMajorPerformanceCaveat:!1});return n.debug.checkShaderErrors=!0,n.outputColorSpace=Ie,n.toneMapping=4,n.toneMappingExposure=t.exposure??1,n.shadowMap.enabled=!1,n.shadowMap.type=2,n.setClearColor(0,1),n}function Eu(e,t){let n=xu[t]??xu.medium;return e.setPixelRatio(Math.min(window.devicePixelRatio||1,n.pixelRatio)),e.shadowMap.enabled=n.shadows,n}function Du(e,t,n){let r=()=>{let r=window.innerWidth,i=window.innerHeight;e.setSize(r,i,!1),t.aspect=r/Math.max(i,1),t.updateProjectionMatrix(),n?.(r,i)};return r(),window.addEventListener(`resize`,r),()=>window.removeEventListener(`resize`,r)}var Z=(e,t)=>({value:e,dot:t}),Ou={mercury:{a:Z(.38709927,37e-8),e:Z(.20563593,1906e-8),I:Z(7.00497902,-.00594749),L:Z(252.2503235,149472.67411175),peri:Z(77.45779628,.16047689),node:Z(48.33076593,-.12534081)},venus:{a:Z(.72333566,39e-7),e:Z(.00677672,-4107e-8),I:Z(3.39467605,-7889e-7),L:Z(181.9790995,58517.81538729),peri:Z(131.60246718,.00268329),node:Z(76.67984255,-.27769418)},earth:{a:Z(1.00000261,562e-8),e:Z(.01671123,-4392e-8),I:Z(-1531e-8,-.01294668),L:Z(100.46457166,35999.37244981),peri:Z(102.93768193,.32327364),node:Z(0,0)},mars:{a:Z(1.52371034,1847e-8),e:Z(.0933941,7882e-8),I:Z(1.84969142,-.00813131),L:Z(-4.55343205,19140.30268499),peri:Z(-23.94362959,.44441088),node:Z(49.55953891,-.29257343)},jupiter:{a:Z(5.202887,-11607e-8),e:Z(.04838624,-13253e-8),I:Z(1.30439695,-.00183714),L:Z(34.39644051,3034.74612775),peri:Z(14.72847983,.21252668),node:Z(100.47390909,.20469106)},saturn:{a:Z(9.53667594,-.0012506),e:Z(.05386179,-50991e-8),I:Z(2.48599187,.00193609),L:Z(49.95424423,1222.49362201),peri:Z(92.59887831,-.41897216),node:Z(113.66242448,-.28867794)},uranus:{a:Z(19.18916464,-.00196176),e:Z(.04725744,-4397e-8),I:Z(.77263783,-.00242939),L:Z(313.23810451,428.48202785),peri:Z(170.9542763,.40805281),node:Z(74.01692503,.04240589)},neptune:{a:Z(30.06992276,26291e-8),e:Z(.00859048,5105e-8),I:Z(1.77004347,35372e-8),L:Z(-55.12002969,218.45945325),peri:Z(44.96476227,-.32241464),node:Z(131.78422574,-.00508664)}};function ku(e){let t={};for(let[n,r]of Object.entries(e))t[n]=r.value,t[`${n}Dot`]=r.dot;return t}var Au=Object.fromEntries(Object.entries(Ou).map(([e,t])=>[e,ku(t)])),ju={aKm:384400,e:.0549,inclinationDeg:5.145,periodDays:27.321661,meanLongitudeJ2000:218.316,meanLongitudeRatePerDay:13.176396},Q={sun2k:`planets/sun_2k.jpg`,sun8k:`sun/sun_8k.jpg`,mercury:`planets/mercury.jpg`,mercuryNormal:`planets/mercury_normal_2k.jpg`,venusSurface:`planets/venus_surface.jpg`,venusNormal:`planets/venus_normal_2k.jpg`,venusAtmosphere:`planets/venus_atmosphere.jpg`,earthDay2k:`planets/earth_day_2k.jpg`,earthNight2k:`planets/earth_night_2k.jpg`,earthClouds2k:`planets/earth_clouds_2k.jpg`,earthNormal2k:`earth/earth_normal_2k.jpg`,earthSpecular2k:`earth/earth_specular_2k.jpg`,earthDay8k:`earth/earth_day_8k.jpg`,earthNight8k:`earth/earth_night_8k.jpg`,earthClouds8k:`earth/earth_clouds_8k.jpg`,earthNormal4k:`earth/earth_normal_4k.jpg`,earthSpecular4k:`earth/earth_specular_4k.jpg`,mars:`planets/mars.jpg`,jupiter:`planets/jupiter.jpg`,saturn:`planets/saturn.jpg`,uranus:`planets/uranus.jpg`,neptune:`planets/neptune.jpg`,moon2k:`planets/moon_2k.jpg`,moonNormal2k:`planets/moon_normal_2k.jpg`,moon8k:`moon/moon_8k.jpg`,moonNormal4k:`moon/moon_normal_4k.jpg`,saturnRing:`rings/saturn_ring_alpha.png`,milkyway:`sky/milkyway_2k.jpg`,noiseFbm:`generated/noise_fbm.png`,noiseWarp:`generated/noise_warp.png`,moonTex:e=>`generated/moons/${e}_albedo.jpg`,moonNormal:e=>`generated/moons/${e}_normal.jpg`},Mu={id:`sun`,kind:`star`,name:{id:`Matahari`,en:`Sun`},radiusKm:696340,displayRadius:Rl(696340),rotationHours:609.12,axialTilt:7.25,color:16765567,textures:{surface:Q.sun2k,surfaceHero:Q.sun8k},coronaScale:1.22},Nu=[{id:`mercury`,kind:`planet`,name:{id:`Merkurius`,en:`Mercury`},radiusKm:2440,elements:Au.mercury,rotationHours:1407.6,axialTilt:.034,oblateness:.999,color:11051675,textures:{surface:Q.mercury,normal:Q.mercuryNormal},atmosphere:null,cameraHint:{minPolar:.12,maxPolar:Math.PI-.12}},{id:`venus`,kind:`planet`,name:{id:`Venus`,en:`Venus`},radiusKm:6052,elements:Au.venus,rotationHours:-5832.5,axialTilt:177.36,oblateness:.999,color:14270586,textures:{surface:Q.venusSurface,normal:Q.venusNormal,cloudDeck:Q.venusAtmosphere},atmosphere:{color:15126418,intensity:1.55,scale:1.055,power:2.3},cloudDeck:{mapKey:`cloudDeck`,alphaFromMap:!1,scale:1.018,rotationHours:-220,opacity:.94,tint:16773320},lighting:{terminatorSoftness:.16}},{id:`earth`,kind:`planet`,name:{id:`Bumi`,en:`Earth`},radiusKm:6371,elements:Au.earth,rotationHours:23.9345,useGmst:!0,axialTilt:23.44,poleEclipticLongitude:0,oblateness:.9966,color:4161494,normalScale:2.2,textures:{surface:Q.earthDay2k,surfaceHero:Q.earthDay8k,night:Q.earthNight2k,nightHero:Q.earthNight8k,clouds:Q.earthClouds2k,cloudsHero:Q.earthClouds8k,normal:Q.earthNormal2k,normalHero:Q.earthNormal4k,specular:Q.earthSpecular2k,specularHero:Q.earthSpecular4k},atmosphere:{color:5939168,intensity:1.25,scale:1.032,power:3.1},cloudDeck:{mapKey:`clouds`,alphaFromMap:!0,scale:1.012,rotationHours:21.6,opacity:.86,tint:16777215},lighting:{terminatorSoftness:.09,nightIntensity:.95,specularStrength:1.1,shininess:56}},{id:`mars`,kind:`planet`,name:{id:`Mars`,en:`Mars`},radiusKm:3390,elements:Au.mars,rotationHours:24.6229,axialTilt:25.19,oblateness:.994,color:12665870,textures:{surface:Q.mars},atmosphere:{color:13667164,intensity:.42,scale:1.022,power:3.4},lighting:{terminatorSoftness:.14}},{id:`jupiter`,kind:`planet`,name:{id:`Jupiter`,en:`Jupiter`},radiusKm:69911,elements:Au.jupiter,rotationHours:9.925,axialTilt:3.13,oblateness:.935,color:14201466,textures:{surface:Q.jupiter},atmosphere:{color:14731424,intensity:.55,scale:1.026,power:3},turbulence:{amplitude:.012,speed:.035,warp:Q.noiseWarp},rings:{inner:1.42,outer:1.81,opacity:.16,color:11575436,procedural:`faint`},lighting:{terminatorSoftness:.2,bandShading:!0}},{id:`saturn`,kind:`planet`,name:{id:`Saturnus`,en:`Saturn`},radiusKm:58232,elements:Au.saturn,rotationHours:10.656,axialTilt:26.73,oblateness:.902,color:14930851,textures:{surface:Q.saturn},atmosphere:{color:15786160,intensity:.5,scale:1.028,power:3},rings:{inner:1.11,outer:2.35,opacity:1,color:14207144,texture:Q.saturnRing,shadows:!0},lighting:{terminatorSoftness:.18,bandShading:!0}},{id:`uranus`,kind:`planet`,name:{id:`Uranus`,en:`Uranus`},radiusKm:25362,elements:Au.uranus,rotationHours:-17.24,axialTilt:97.77,oblateness:.977,color:10478568,textures:{surface:Q.uranus},atmosphere:{color:11070706,intensity:.9,scale:1.045,power:2.7},rings:{inner:1.62,outer:2,opacity:.34,color:9214632,procedural:`narrow`},lighting:{terminatorSoftness:.22}},{id:`neptune`,kind:`planet`,name:{id:`Neptunus`,en:`Neptune`},radiusKm:24622,elements:Au.neptune,rotationHours:16.11,axialTilt:28.32,oblateness:.983,color:4153296,textures:{surface:Q.neptune},atmosphere:{color:6260464,intensity:.95,scale:1.045,power:2.7},rings:{inner:1.7,outer:2.5,opacity:.18,color:8359592,procedural:`faint`},turbulence:{amplitude:.006,speed:.05,warp:Q.noiseWarp},lighting:{terminatorSoftness:.22,bandShading:!0}}],Pu={earth:[{id:`moon`,name:{id:`Bulan`,en:`Moon`},radiusKm:1737,displayRadius:.42,orbit:4.3,periodDays:27.321661,color:12433068,textures:{surface:Q.moon2k,normal:Q.moonNormal2k,surfaceHero:Q.moon8k,normalHero:Q.moonNormal4k},inclinationDeg:5.145,tidallyLocked:!0,phaseOffset:.63}],mars:[{id:`phobos`,name:{id:`Phobos`,en:`Phobos`},radiusKm:11.3,displayRadius:.07,orbit:1.85,periodDays:.31891,color:8221804,textures:{surface:Q.moonTex(`phobos`),normal:Q.moonNormal(`phobos`)},irregular:!0,inclinationDeg:1.08,tidallyLocked:!0},{id:`deimos`,name:{id:`Deimos`,en:`Deimos`},radiusKm:6.2,displayRadius:.05,orbit:2.75,periodDays:1.263,color:9340282,textures:{surface:Q.moonTex(`deimos`),normal:Q.moonNormal(`deimos`)},irregular:!0,inclinationDeg:1.79,tidallyLocked:!0}],jupiter:[{id:`io`,name:{id:`Io`,en:`Io`},radiusKm:1821,displayRadius:.3,orbit:7.4,periodDays:1.769138,color:14204768,textures:{surface:Q.moonTex(`io`),normal:Q.moonNormal(`io`)},tidallyLocked:!0},{id:`europa`,name:{id:`Europa`,en:`Europa`},radiusKm:1561,displayRadius:.26,orbit:9,periodDays:3.551181,color:14078144,textures:{surface:Q.moonTex(`europa`),normal:Q.moonNormal(`europa`)},tidallyLocked:!0},{id:`ganymede`,name:{id:`Ganymede`,en:`Ganymede`},radiusKm:2634,displayRadius:.42,orbit:11.3,periodDays:7.154553,color:10129278,textures:{surface:Q.moonTex(`ganymede`),normal:Q.moonNormal(`ganymede`)},tidallyLocked:!0},{id:`callisto`,name:{id:`Callisto`,en:`Callisto`},radiusKm:2410,displayRadius:.39,orbit:14.8,periodDays:16.689017,color:6971994,textures:{surface:Q.moonTex(`callisto`),normal:Q.moonNormal(`callisto`)},tidallyLocked:!0}],saturn:[{id:`enceladus`,name:{id:`Enceladus`,en:`Enceladus`},radiusKm:252,displayRadius:.14,orbit:9.3,periodDays:1.370218,color:15265522,textures:{surface:Q.moonTex(`enceladus`),normal:Q.moonNormal(`enceladus`)},tidallyLocked:!0,geysers:!0},{id:`rhea`,name:{id:`Rhea`,en:`Rhea`},radiusKm:764,displayRadius:.19,orbit:10.6,periodDays:4.518212,color:13157564,textures:{surface:Q.moonTex(`rhea`),normal:Q.moonNormal(`rhea`)},tidallyLocked:!0},{id:`titan`,name:{id:`Titan`,en:`Titan`},radiusKm:2575,displayRadius:.4,orbit:13,periodDays:15.945,color:13605450,textures:{surface:Q.moonTex(`titan`),normal:Q.moonNormal(`titan`)},atmosphere:{color:14197838,intensity:.7,scale:1.05,power:2.6},tidallyLocked:!0}],uranus:[{id:`titania`,name:{id:`Titania`,en:`Titania`},radiusKm:789,displayRadius:.19,orbit:5.4,periodDays:8.706234,color:12630192,textures:{surface:Q.moonTex(`titania`),normal:Q.moonNormal(`titania`)},tidallyLocked:!0},{id:`oberon`,name:{id:`Oberon`,en:`Oberon`},radiusKm:761,displayRadius:.18,orbit:6.7,periodDays:13.463234,color:11577504,textures:{surface:Q.moonTex(`oberon`),normal:Q.moonNormal(`oberon`)},tidallyLocked:!0}],neptune:[{id:`triton`,name:{id:`Triton`,en:`Triton`},radiusKm:1353,displayRadius:.24,orbit:7.6,periodDays:-5.876854,color:14207172,textures:{surface:Q.moonTex(`triton`),normal:Q.moonNormal(`triton`)},inclinationDeg:156.885,tidallyLocked:!0}]};function Fu(e,t){let n=Math.abs(e.periodDays)*24;return{...e,kind:`moon`,parent:t.id,angularSpeed:Math.PI*2/(e.periodDays*24),rotationHours:e.tidallyLocked?n:n*.5,axialTilt:0,oblateness:1}}for(let e of Nu)e.moons=(Pu[e.id]??[]).map(t=>Fu(t,e));for(let e of Nu)e.displayRadius=Rl(e.radiusKm),e.displayDistance=zl(e.elements.a);var Iu={id:`asteroid-belt`,inner:zl(2.06),outer:zl(3.28),count:3600,thickness:6,color:10128506,seed:1234567},Lu={id:`kuiper-belt`,inner:zl(33),outer:zl(48),count:2200,thickness:9,color:9414344,seed:7654321},Ru=class{#e=new G;constructor(e,t,n={}){this.container=e,this.entries=[],this.enabled=!0,this.language=n.language??`id`;for(let n of t){let t=document.createElement(`button`);t.type=`button`,t.className=`label label--${n.kind}`,t.dataset.bodyId=n.id,t.textContent=n.name[this.language]??n.name.id;let r=`#${(n.body.color??9082029).toString(16).padStart(6,`0`)}`;t.style.setProperty(`--label-color`,r),e.appendChild(t),this.entries.push({...n,element:t,visible:!1})}}setLanguage(e){this.language=e;for(let t of this.entries)t.element.textContent=t.name[e]??t.name.id}setEnabled(e){if(this.enabled=e,!e)for(let e of this.entries)e.element.classList.remove(`is-visible`)}update(e,t){let n=this.container.clientWidth||window.innerWidth,r=this.container.clientHeight||window.innerHeight,i=r/2,a=Math.tan(e.fov*Math.PI/360),o=Math.min(1,Math.max(0,(t.zoom-.16)/.22));for(let s of this.entries){if(!this.enabled||o<=.01){s.visible&&=(s.element.classList.remove(`is-visible`),!1);continue}s.body.getWorldPosition(this.#e);let c=this.#e.distanceTo(e.position);if(this.#e.project(e),this.#e.z>1||c>4e3){s.visible&&=(s.element.classList.remove(`is-visible`),!1);continue}let l=(this.#e.x*.5+.5)*n,u=(-this.#e.y*.5+.5)*r,d=s.body.displayRadius/Math.max(c,.001)/a*i,f=Math.min(d+14,i*.6),p=t.focusId===s.id;s.element.style.transform=`translate3d(${l.toFixed(1)}px, ${(u-f).toFixed(1)}px, 0) translate(-50%, -100%)`,s.element.style.opacity=String((o*(p?1:.78)*(d>i*.9?.35:1)).toFixed(3)),s.element.style.pointerEvents=o>.5?`auto`:`none`,s.visible||=(s.element.classList.add(`is-visible`),!0)}}dispose(){for(let e of this.entries)e.element.remove();this.entries=[]}};function zu(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function Bu(e){let t=new Li(1,0),n=t.attributes.position,r=zu(e),i=new G;for(let e=0;e<n.count;e++){i.fromBufferAttribute(n,e);let t=.62+r()*.72;n.setXYZ(e,i.x*t,i.y*t*.86,i.z*t)}return n.needsUpdate=!0,t.computeVertexNormals(),t}var Vu=class{constructor(e,t){this.config=e,this.count=Math.min(e.count,t.asteroids),this.radii=new Float32Array(this.count),this.initialAngles=new Float32Array(this.count),this.angularSpeeds=new Float32Array(this.count),this.heights=new Float32Array(this.count),this.tumbles=[],this.scales=new Float32Array(this.count*3);let n=new Rr({color:e.color,transparent:!0,opacity:.92,fog:!1});this.mesh=new ci(Bu(e.seed),n,this.count),this.mesh.name=`asteroid-belt`,this.mesh.frustumCulled=!1,this.mesh.instanceMatrix.setUsage(He),this.#e(),this.update(0)}#e(){let{inner:e,outer:t,thickness:n}=this.config,r=zu(this.config.seed+1);for(let i=0;i<this.count;i++){let a=r()**1.35;r()<.2&&(a=Math.min(1,a+.22));let o=2.06+a*(3.28-2.06);this.radii[i]=Math.min(t,Math.max(e,this.#t(o))),this.initialAngles[i]=r()*Math.PI*2;let s=o**1.5*365.25*24;this.angularSpeeds[i]=Math.PI*2/s,this.heights[i]=(r()+r()+r()-1.5)*.85*n,this.tumbles.push(new Dt().setFromEuler(new on(r()*6.28,r()*6.28,r()*6.28)));let c=.045+r()**2.6*.26;this.scales[i*3+0]=c,this.scales[i*3+1]=c,this.scales[i*3+2]=c}}#t(e){let{inner:t,outer:n}=this.config,r=(e-2.06)/(3.28-2.06);return t+(n-t)*r}update(e){let t=new Yt,n=new Dt,r=new G,i=new G,a=new G(0,1,0),o=new Dt;for(let s=0;s<this.count;s++){let c=this.initialAngles[s]+e*this.angularSpeeds[s];r.set(Math.cos(c)*this.radii[s],this.heights[s],Math.sin(c)*this.radii[s]),o.setFromAxisAngle(a,c*.6),n.copy(o).multiply(this.tumbles[s]),i.set(this.scales[s*3],this.scales[s*3+1],this.scales[s*3+2]),t.compose(r,n,i),this.mesh.setMatrixAt(s,t)}this.mesh.instanceMatrix.needsUpdate=!0}setVisible(e){this.mesh.visible=e}dispose(){this.mesh.geometry.dispose(),this.mesh.material.dispose(),this.mesh.dispose()}},Hu=class{constructor(e,t){this.count=Math.min(e.count,t.kuiper);let n=zu(e.seed),r=new Float32Array(this.count*3);for(let t=0;t<this.count;t++){let i=n()*Math.PI*2,a=n()**.85,o=e.inner+(e.outer-e.inner)*a;r[t*3+0]=Math.cos(i)*o,r[t*3+1]=(n()+n()-1)*e.thickness,r[t*3+2]=Math.sin(i)*o}let i=new Er;i.setAttribute(`position`,new mr(r,3)),this.points=new Oi(i,new Ci({color:e.color,size:.55,sizeAttenuation:!0,transparent:!0,opacity:.42,depthWrite:!1})),this.points.name=`kuiper-belt`,this.points.frustumCulled=!1}update(e){this.points.rotation.y=e*15e-6}setVisible(e){this.points.visible=e}dispose(){this.points.geometry.dispose(),this.points.material.dispose()}},Uu=`
float hash13(vec3 p) {
...
`;function qu(e,t={}){let n=e.lighting??{},r={},i={uSunDirection:{value:new G(1,0,0)},uSunColor:{value:new J(16774112)},uTerminator:{value:n.terminatorSoftness??.1},uAmbient:{value:n.ambient??1},uTint:{value:new J(e.tint??16777215)},uOpacity:{value:1}};if(t.map&&(r.USE_MAP=``,i.uMap={value:t.map}),t.normalMap){r.USE_NORMAL_MAP=``,i.uNormalMap={value:t.normalMap};let e=t.normalScale??1;i.uNormalScale={value:new W(e,-e)}}t.specularMap&&(r.USE_SPECULAR=``,i.uSpecularMap={value:t.specularMap},i.uSpecularStrength={value:n.specularStrength??.9},i.uShininess={value:n.shininess??48}),t.nightMap&&(r.USE_NIGHT=``,i.uNightMap={value:t.nightMap},i.uNightIntensity={value:n.nightIntensity??.85});let a=e.turbulence;a&&t.warpMap&&(r.USE_TURBULENCE=``,i.uWarpMap={value:t.warpMap},i.uWarpAmount={value:a.amplitude??.01},i.uWarpTime={value:0}),e.rings?.shadows&&(r.USE_RING_SHADOW=``,i.uRingCenter={value:new G},i.uRingNormal={value:new G(0,1,0)},i.uRingInner={value:0},i.uRingOuter={value:1});let o=new Yi({name:`planet:${e.id}`,defines:r,uniforms:i,vertexShader:Gu,fragmentShader:Ku,transparent:!1});return o.userData.body=e,o}var Ju=`
varying vec2 vUv;
varying vec3 vNormal;
varying vec3 vWorldPosition;
...
`;function Xu(e,t={},n=!0){let r={};return n&&(r.USE_ALPHA_FROM_MAP=``),new Yi({name:`clouds`,defines:r,uniforms:{uMap:{value:e},uTint:{value:new J(t.tint??16777215)},uOpacity:{value:t.opacity??.9},uRimStrength:{value:t.rimStrength??.6},uSunDirection:{value:new G(1,0,0)},uSunColor:{value:new J(16774112)},uTerminator:{value:.22},uAmbient:{value:1}},vertexShader:Ju,fragmentShader:Yu,side:0,transparent:!0,depthWrite:!1})}var Zu=`
varying vec3 vNormal;
varying vec3 vWorldPosition;
...
`;function $u(e,t=`back`){let n=t===`back`;return new Yi({name:`atmosphere:${t}`,uniforms:{uSunDirection:{value:new G(1,0,0)},uSunColor:{value:new J(16774112)},uColor:{value:new J(e.color)},uIntensity:{value:e.intensity*(n?1:.3)},uPower:{value:e.power},uForwardScatter:{value:n?1.6:.5},uNightFalloff:{value:e.nightFalloff??.55}},vertexShader:Zu,fragmentShader:Qu,side:+!!n,blending:2,transparent:!0,depthWrite:!1})}function ed(e,t={}){let n=e.atmosphere;if(!n)return null;let r=t.layers??2,i=t.segments??48,a=e.displayRadius*(n.scale??1.03),o=new wn;o.name=`atmosphere:${e.id}`;let s=new Bi(a,i*2,i);if(r>=1){let e=new Xr(s,$u(n,`back`));e.name=`atmosphere-back`,e.renderOrder=3,o.add(e)}if(r>=2){let e=new Xr(s,$u(n,`front`));e.name=`atmosphere-front`,e.renderOrder=6,o.add(e)}return o.userData.geometry=s,o}var td=`
varying vec3 vWorldPosition;
...
`;function rd(e,t){return new Yi({name:`ring:${e.procedural??`textured`}`,uniforms:{uAlphaMap:{value:t},uColor:{value:new J(e.color)},uSunColor:{value:new J(16774112)},uSunDirection:{value:new G(1,0,0)},uInner:{value:0},uOuter:{value:1},uOpacity:{value:e.opacity??1},uBrightness:{value:e.brightness??1.05},uAmbient:{value:e.ambient??.02},uPlanetCenter:{value:new G},uPlanetRadius:{value:1}},vertexShader:td,fragmentShader:nd,side:2,transparent:!0,depthWrite:!1})}function id(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}var ad=1024,od=4;function sd(e,n=4242){let r=document.createElement(`canvas`);r.width=ad,r.height=od;let i=r.getContext(`2d`);i.fillStyle=`#000000`,i.fillRect(0,0,ad,od);let a=id(n),s=i.createLinearGradient(0,0,ad,0);if(e===`narrow`)for(let[e,t]of[[0,0],[.16,0],[.18,.55],[.2,.08],[.34,.06],[.36,.72],[.38,.1],[.55,.05],[.57,.9],[.63,.35],[.65,.07],[.78,.06],[.8,.3],[.83,.05],[1,0]])s.addColorStop(e,`rgba(255,255,255,${t})`);else for(let e=0;e<=64;e++){let t=e/64,n=Math.sin(Math.min(t,.92)*Math.PI*.85),r=.55+.45*a(),i=Math.max(0,n*r*(1-t**3.2));s.addColorStop(t,`rgba(255,255,255,${i.toFixed(3)})`)}i.fillStyle=s,i.fillRect(0,0,ad,od);let c=new ji(r);return c.colorSpace=Ie,c.wrapS=t,c.wrapT=t,c.minFilter=o,c.magFilter=o,c.generateMipmaps=!1,c.needsUpdate=!0,c}function cd(e,t,n={}){let r=e.rings;if(!r)return null;let i=e.displayRadius*r.inner,a=e.displayRadius*r.outer,o=r.texture?t.get(r.texture):sd(r.procedural??`faint`,e.id.length*7919);if(!o)return null;let s=new zi(i,a,n.segments??256,1);s.rotateX(-Math.PI/2);let c=rd(r,o);c.uniforms.uInner.value=i,c.uniforms.uOuter.value=a;let l=new Xr(s,c);return l.name=`rings:${e.id}`,l.renderOrder=2,l.userData.body=e,l}function ld(e,t,n){let i=new $r(new Uint8Array([e,t,n,255]),1,1,T);return i.needsUpdate=!0,i.magFilter=r,i.minFilter=r,i.generateMipmaps=!1,i}var ud={map:()=>ld(150,150,150),normal:()=>ld(128,128,255),specular:()=>ld(0,0,0),night:()=>ld(0,0,0),clouds:()=>ld(0,0,0),ozone:()=>ld(255,255,255),warp:()=>ld(128,128,128)};function dd(e,t,n){let r=ud[n]??ud.map;return t?e.get(t)??r():r()}function fd(e,t,n){let r=Math.sin(e*127.1+t*311.7+n*74.7)*43758.5453;return r-Math.floor(r)}function pd(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=Math.floor(n),o=e-r,s=t-i,c=n-a,l=o*o*(3-2*o),u=s*s*(3-2*s),d=c*c*(3-2*c),f=(e,t,n)=>e+(t-e)*n,p=fd(r,i,a),m=fd(r+1,i,a),h=fd(r,i+1,a),g=fd(r+1,i+1,a),_=fd(r,i,a+1),v=fd(r+1,i,a+1),y=fd(r,i+1,a+1),b=fd(r+1,i+1,a+1);return f(f(f(p,m,l),f(h,g,l),u),f(f(_,v,l),f(y,b,l),u),d)}function md(e,t,n,r=4){let i=0,a=.5,o=0;for(let s=0;s<r;s++)i+=pd(e,t,n)*a,o+=a,e*=2.03,t*=2.03,n*=2.03,a*=.5;return i/o}function hd(e,t,n){let r=e.attributes.position,i=new G;for(let e=0;e<r.count;e++){i.fromBufferAttribute(r,e);let a=i.length()||1,o=i.x/a,s=i.y/a,c=i.z/a,l=1+(md(o*2.2+n,s*2.2+n*1.7,c*2.2,4)-.5)*2*t;r.setXYZ(e,i.x*l,i.y*l,i.z*l)}r.needsUpdate=!0}function gd(e,t,n=1,r=null){let i=Math.max(8,t),a=new Bi(e,i*2,i);return n&&Math.abs(n-1)>1e-4&&a.scale(1,n,1),r&&hd(a,r.amount??.26,r.seed??1),a.computeVertexNormals(),a}var _d=class e{constructor(e,t){this.def=e,this.id=e.id,this.name=e.name,this.kind=e.kind,this.assets=t.assets,this.preset=t.preset,this.isMoon=e.kind===`moon`,this.displayRadius=e.displayRadius,this.displayDistance=e.displayDistance??0,this.spinAngle=0,this.orbitAngle=0,this.sunMaterials=[],this.textureSlots={};let n=t.segments??(this.isMoon?this.preset.sphereSegments.moon:this.preset.sphereSegments.planet);this.group=new wn,this.group.name=`body:${e.id}`,this.tiltGroup=new wn,this.tiltGroup.name=`tilt:${e.id}`,this.tiltGroup.rotation.order=`YXZ`,this.tiltGroup.rotation.y=-((e.poleEclipticLongitude??0)*Math.PI)/180,this.tiltGroup.rotation.x=(e.axialTilt??0)*Math.PI/180,this.group.add(this.tiltGroup),this.#e(n),this.#t(n),this.#n(),this.#r(),this.moons=[],this.moonPivots=[]}#e(e){let t=this.def,n=t.textures??{},r=gd(this.displayRadius,e,t.oblateness??1,t.irregular?{amount:.3,seed:t.id.charCodeAt(0)}:null),i=qu(t,{map:dd(this.assets,n.surface,`map`),normalMap:n.normal?dd(this.assets,n.normal,`normal`):null,normalScale:t.normalScale??1,specularMap:n.specular?dd(this.assets,n.specular,`specular`):null,nightMap:n.night?dd(this.assets,n.night,`night`):null,warpMap:t.turbulence?dd(this.assets,t.turbulence.warp,`warp`):null});this.surfaceMaterial=i,this.surfaceMesh=new Xr(r,i),this.surfaceMesh.name=`surface:${t.id}`,this.surfaceMesh.userData.body=t,this.surfaceMesh.userData.pickable=!0,this.tiltGroup.add(this.surfaceMesh),this.sunMaterials.push(i),this.textureSlots.map={key:n.surface,heroKey:n.surfaceHero,material:i,uniform:`uMap`},n.normal&&(this.textureSlots.normal={key:n.normal,heroKey:n.normalHero,material:i,uniform:`uNormalMap`}),n.specular&&(this.textureSlots.specular={key:n.specular,heroKey:n.specularHero,material:i,uniform:`uSpecularMap`}),n.night&&(this.textureSlots.night={key:n.night,heroKey:n.nightHero,material:i,uniform:`uNightMap`})}#t(e){let t=this.def.cloudDeck;if(!t)return;let n=this.def.textures??{},r=n[t.mapKey??`clouds`],i=t.alphaFromMap??!0,a=Xu(r?dd(this.assets,r,i?`clouds`:`ozone`):dd(this.assets,null,`ozone`),t,i);this.cloudMaterial=a,this.cloudMesh=new Xr(gd(this.displayRadius*(t.scale??1.012),e,this.def.oblateness??1),a),this.cloudMesh.name=`clouds:${this.def.id}`,this.cloudMesh.renderOrder=4,this.tiltGroup.add(this.cloudMesh),this.sunMaterials.push(a),r&&(this.textureSlots.clouds={key:r,heroKey:n.cloudsHero,material:a,uniform:`uMap`})}#n(){let e=ed(this.def,{layers:this.preset.atmosphereLayers,segments:40});if(e){this.atmosphere=e,this.tiltGroup.add(e);for(let t of e.children)this.sunMaterials.push(t.material)}}#r(){if(!this.def.rings)return;let e=cd(this.def,this.assets.textures);e&&(this.rings=e,this.tiltGroup.add(e),this.sunMaterials.push(e.material))}attachMoon(t,n={}){let r=new e(t,{assets:this.assets,preset:this.preset}),i=n.mode===`ecliptic`?this.group:this.tiltGroup,a=new wn;a.name=`orbit-plane:${t.id}`,a.rotation.x=(t.inclinationDeg??0)*Math.PI/180;let o=new wn;o.name=`orbit:pivot:${t.id}`;let s=new wn;return s.position.set(t.orbit,0,0),s.add(r.group),o.add(s),a.add(o),i.add(a),r.pivot=o,r.orbitRadius=t.orbit,r.lockedToPivot=!!t.tidallyLocked,r.initialLongitude=n.initialLongitude??(t.phaseOffset??0)*Math.PI*2,this.moons.push(r),r}updateTransform(e,t){let n=this.def;if(this.isMoon)this.pivot&&(this.orbitAngle=this.initialLongitude+e.elapsedHours*n.angularSpeed,this.pivot.rotation.y=this.orbitAngle);else if(t&&n.elements){let r=t(n.elements,e.centuries);this.group.position.set(r.x,r.y,r.z)}n.useGmst?this.spinAngle=gu(e.julian)*Math.PI/180+Math.PI:n.rotationHours&&(this.spinAngle=Math.PI*2*e.elapsedHours/n.rotationHours);let r=this.lockedToPivot?0:this.spinAngle;if(this.surfaceMesh.rotation.y=r,this.cloudMesh){let t=n.cloudDeck;this.cloudMesh.rotation.y=t?.rotationHours?Math.PI*2*e.elapsedHours/t.rotationHours:r*1.08}if(n.turbulence){let t=this.surfaceMaterial;t.uniforms.uWarpTime&&(t.uniforms.uWarpTime.value=e.elapsedHours*n.turbulence.speed)}}updateSunLighting(e){this.group.getWorldPosition(vd),yd.copy(e).sub(vd);let t=yd.length();t>1e-6&&yd.divideScalar(t);for(let e of this.sunMaterials){let t=e.uniforms.uSunDirection;t&&t.value.copy(yd)}if(this.rings){let e=this.surfaceMaterial;e.uniforms.uRingCenter&&(this.tiltGroup.getWorldQuaternion(xd),bd.set(0,1,0).applyQuaternion(xd).normalize(),e.uniforms.uRingCenter.value.copy(vd),e.uniforms.uRingNormal.value.copy(bd));let t=this.rings.material;t.uniforms.uPlanetCenter.value.copy(vd),t.uniforms.uPlanetRadius.value=this.displayRadius}}getWorldPosition(e){return this.group.getWorldPosition(e)}upgradeTexture(e,t){let n=this.textureSlots[e];if(!n?.heroKey)return!1;let r=t.get(n.heroKey);return!r||n.heroApplied?!1:(n.material.uniforms[n.uniform].value=r,n.heroApplied=!0,!0)}pendingHeroTextures(){return Object.values(this.textureSlots).filter(e=>e.heroKey&&!e.heroApplied).map(e=>e.heroKey)}baseTextureKeys(){return Object.values(this.textureSlots).map(e=>e.key).filter(Boolean)}},vd=new G,yd=new G,bd=new G,xd=new Dt;function Sd(e,t=360){let n=[],r=zl(e.a);for(let i=0;i<=t;i++){let a=i/t*360,o=hu({a:e.a,e:e.e,I:e.I,L:e.peri+a,peri:e.peri,node:e.node},0),s=o.r>0?r/o.r:0,c=_u(o.x*s,o.y*s,o.z*s);n.push(new G(c.x,c.y,c.z))}return n}var Cd=class{constructor(e,t={}){this.group=new wn,this.group.name=`orbit-lines`;for(let n of e){let e=new xi(new Er().setFromPoints(Sd(n.elements,t.samples??320)),new pi({color:n.color,transparent:!0,opacity:t.opacity??.26,depthWrite:!1}));e.name=`orbit:${n.id}`,e.renderOrder=-1,this.group.add(e)}}setVisible(e){this.group.visible=e}setOpacity(e){for(let t of this.group.children)t.material.opacity=e}dispose(){for(let e of this.group.children)e.geometry.dispose(),e.material.dispose()}},wd=`
...
`,Ed=[{color:10203391,weight:.03,size:2.8},{color:11190271,weight:.07,size:2.4},{color:16316415,weight:.16,size:2},{color:16774378,weight:.28,size:1.8},{color:16767412,weight:.32,size:1.6},{color:16756858,weight:.14,size:1.4}];function Dd(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}var Od=`
varying vec2 vUv;
...
`,Ad=class{constructor(e,t={}){let n=t.radius??4e3;this.group=new wn,this.group.name=`starfield`,this.domeMaterial=new Yi({name:`starfield:dome`,uniforms:{uMap:{value:e},uIntensity:{value:t.intensity??.62},uContrast:{value:t.contrast??1.35},uTint:{value:new J(12570879)}},vertexShader:Od,fragmentShader:kd,side:1,depthTest:!1,depthWrite:!1}),this.dome=new Xr(new Bi(n,48,32),this.domeMaterial),this.dome.name=`milkyway`,this.dome.renderOrder=-1e3,this.dome.frustumCulled=!1,this.group.add(this.dome);let r=t.starCount??4500;this.starMaterial=new Yi({name:`starfield:stars`,uniforms:{uTime:{value:0},uBrightness:{value:t.starBrightness??1},uPixelRatio:{value:1}},vertexShader:wd,fragmentShader:Td,transparent:!0,blending:2,depthTest:!1,depthWrite:!1}),this.stars=new Oi(this.#e(r,n*.9),this.starMaterial),this.stars.name=`stars`,this.stars.renderOrder=-900,this.stars.frustumCulled=!1,this.group.add(this.stars)}#e(e,t){let n=Dd(20260920),r=new Float32Array(e*3),i=new Float32Array(e*3),a=new Float32Array(e),o=new Float32Array(e),s=new J,c=Ed.reduce((e,t)=>e+t.weight,0),l=Ed.map((e=>t=>e+=t.weight/c)(0));for(let c=0;c<e;c++){let e=n()*2-1,u=n()*Math.PI*2,d=Math.sqrt(1-e*e);r[c*3+0]=t*d*Math.cos(u),r[c*3+1]=t*e,r[c*3+2]=t*d*Math.sin(u);let f=n(),p=Ed[l.findIndex(e=>f<=e)]??Ed[3];s.set(p.color);let m=.45+n()**3.2*.85;i[c*3+0]=s.r*m,i[c*3+1]=s.g*m,i[c*3+2]=s.b*m,a[c]=p.size*(.7+n()*.9),o[c]=n()*Math.PI*2}let u=new Er;return u.setAttribute(`position`,new mr(r,3)),u.setAttribute(`color`,new mr(i,3)),u.setAttribute(`aSize`,new mr(a,1)),u.setAttribute(`aPhase`,new mr(o,1)),u.computeBoundingSphere(),u}update(e,t=1){this.starMaterial.uniforms.uTime.value=e,this.starMaterial.uniforms.uPixelRatio.value=t}dispose(){this.dome.geometry.dispose(),this.domeMaterial.dispose(),this.stars.geometry.dispose(),this.starMaterial.dispose()}},jd=`
varying vec2 vUv;
varying vec3 vNormal;
...
`;function Fd(e){return new Yi({name:`sun:surface`,uniforms:{uMap:{value:e},uTime:{value:0},uNoiseScale:{value:3.2},uHotColor:{value:new J(16767392)},uRimColor:{value:new J(16747068)},uRimStrength:{value:.55},uExposure:{value:1.75},uOpacity:{value:1},uSunDirection:{value:new G(1,0,0)}},vertexShader:jd,fragmentShader:Md,side:0})}function Id(){return new Yi({name:`sun:corona`,uniforms:{uTime:{value:0},uColorInner:{value:new J(16764810)},uColorOuter:{value:new J(16742954)},uIntensity:{value:.95},uPower:{value:2.4},uSunDirection:{value:new G(1,0,0)}},vertexShader:Nd,fragmentShader:Pd,side:1,blending:2,transparent:!0,depthWrite:!1})}var Ld=class{constructor(e,t,n){this.def=n,this.id=n.id,this.name=n.name,this.kind=`star`,this.displayRadius=n.displayRadius,this.isMoon=!1,this.group=new wn,this.group.name=`body:sun`;let r=t.sphereSegments.sun,i=e.get(n.textures.surface);this.surfaceMaterial=Fd(i??Rd()),this.surfaceMesh=new Xr(gd(this.displayRadius,r,1,null),this.surfaceMaterial),this.surfaceMesh.name=`surface:sun`,this.surfaceMesh.userData.body=n,this.surfaceMesh.userData.pickable=!0,this.group.add(this.surfaceMesh),this.coronaMaterial=Id(),this.coronaMesh=new Xr(new Bi(this.displayRadius*(n.coronaScale??1.22),48,32),this.coronaMaterial),this.coronaMesh.name=`corona:sun`,this.coronaMesh.renderOrder=1,this.group.add(this.coronaMesh),this.light=new za(16773328,6,0,0),this.group.add(this.light),this.spinAngle=0,this.textureSlots={map:{key:n.textures.surface,heroKey:n.textures.surfaceHero,material:this.surfaceMaterial,uniform:`uMap`}}}update(e){this.surfaceMaterial.uniforms.uTime.value=e.elapsedSeconds,this.coronaMaterial.uniforms.uTime.value=e.elapsedSeconds,this.def.rotationHours&&(this.spinAngle=Math.PI*2*e.elapsedHours/this.def.rotationHours,this.surfaceMesh.rotation.y=this.spinAngle),this.coronaMesh.rotation.y=this.spinAngle*.25}getWorldPosition(e){return this.group.getWorldPosition(e)}upgradeTexture(e,t){let n=this.textureSlots[e];if(!n?.heroKey||n.heroApplied)return!1;let r=t.get(n.heroKey);return r?(n.material.uniforms[n.uniform].value=r,n.heroApplied=!0,!0):!1}pendingHeroTextures(){return Object.values(this.textureSlots).filter(e=>e.heroKey&&!e.heroApplied).map(e=>e.heroKey)}baseTextureKeys(){return Object.values(this.textureSlots).map(e=>e.key).filter(Boolean)}updateSunLighting(){}};function Rd(){let e=new $r(new Uint8Array([255,240,214,255]),1,1,T);return e.needsUpdate=!0,e.generateMipmaps=!1,e}var zd=[Q.sun2k,Q.milkyway,Q.earthDay2k,Q.earthNight2k,Q.earthClouds2k,Q.earthNormal2k,Q.earthSpecular2k,Q.moon2k,Q.moonNormal2k,Q.saturnRing,Q.noiseFbm,Q.noiseWarp],Bd=[Q.mercury,Q.mercuryNormal,Q.venusSurface,Q.venusNormal,Q.venusAtmosphere,Q.mars,Q.jupiter,Q.saturn,Q.uranus,Q.neptune],Vd=[`earth`,`moon`,`sun`],Hd=16,Ud=class{#e=new G;#t=new Map;constructor(e){this.assets=e.assets,this.preset=e.preset,this.scene=e.scene,this.startDate=e.startDate??new Date,this.root=new wn,this.root.name=`solar-system`,this.scene.add(this.root),this.bodies=new Map,this.pickables=[],this.belt=null,this.kuiper=null,this.orbitLines=null,this.starfield=null,this.ready=!1,this.phaseTwoLoaded=!1,this.#r=(e,t)=>vu(e,t,zl,this.#n)}#n={x:0,y:0,z:0};#r;async init(e){let t=[];for(let e of Nu)for(let n of e.moons??[])n.textures?.surface&&t.push(n.textures.surface),n.textures?.normal&&t.push(n.textures.normal);await this.assets.load([...zd,...t]),this.#i(),this.#o(),this.ready=!0,e?.({loaded:1,total:1}),this.loadRemaining().catch(e=>{console.warn(`[hermes] pemuatan tahap dua gagal sebagian:`,e?.message??e)})}async loadRemaining(){await this.assets.load(Bd),this.#o(),this.phaseTwoLoaded=!0}#i(){this.starfield=new Ad(this.assets.get(Q.milkyway),{starCount:this.preset.starCount,starBrightness:1}),this.root.add(this.starfield.group),this.sun=new Ld(this.assets,this.preset,Mu),this.root.add(this.sun.group),this.bodies.set(Mu.id,this.sun),this.pickables.push(this.sun.surfaceMesh);for(let e of Nu){let t=new _d(e,{assets:this.assets,preset:this.preset});this.root.add(t.group),this.bodies.set(e.id,t),this.pickables.push(t.surfaceMesh);for(let n of e.moons??[]){let r=e.id===`earth`?`ecliptic`:`equatorial`,i=t.attachMoon(n,{mode:r,initialLongitude:e.id===`earth`?this.#a():void 0});this.bodies.set(n.id,i),this.pickables.push(i.surfaceMesh)}}this.orbitLines=new Cd(Nu),this.root.add(this.orbitLines.group),this.belt=new Vu(Iu,this.preset),this.root.add(this.belt.mesh),this.kuiper=new Hu(Lu,this.preset),this.kuiper.setVisible(!1),this.root.add(this.kuiper.points)}#a(){let e=du(this.startDate)-2451545;return(ju.meanLongitudeJ2000+ju.meanLongitudeRatePerDay*e)*Math.PI/180}#o(){for(let e of this.bodies.values())for(let t of Object.values(e.textureSlots)){if(!t.key)continue;let e=this.assets.get(t.key);e&&(t.material.uniforms[t.uniform].value=e)}}update(e,t,n,r){for(let e of this.bodies.values())e!==this.sun&&e.updateTransform(t,this.#r);this.sun.update(t),this.sun.group.getWorldPosition(this.#e);for(let e of this.bodies.values())e.updateSunLighting(this.#e);let i=r>.26;this.belt.setVisible(i),i&&(this.#s=(this.#s+1)%4,this.#s===0&&this.belt.update(t.elapsedHours));let a=r>.74;this.kuiper.setVisible(a),a&&this.kuiper.update(t.elapsedHours),this.starfield.update(t.elapsedSeconds,this.pixelRatio??1),this.#l(n,r)}#s=0;#c=new G;#l(e,t){if(!(!this.preset.heroTextures||t>.3))for(let t of Vd){let n=this.bodies.get(t);if(!n)continue;let r=this.#t.get(t);if(r?.requested||r?.failed||(n.getWorldPosition(this.#c),e.position.distanceTo(this.#c)/n.displayRadius>Hd))continue;let i=n.pendingHeroTextures();i.length!==0&&(this.#t.set(t,{requested:!0}),this.assets.load(i).then(()=>{for(let e of Object.keys(n.textureSlots))n.upgradeTexture(e,this.assets.textures);this.#t.set(t,{requested:!0,applied:!0})}).catch(()=>{this.#t.set(t,{requested:!0,failed:!0})}))}}getBody(e){return this.bodies.get(e)??null}getFocusableBodies(){return[...this.bodies.values()]}setOrbitsVisible(e){this.orbitLines?.setVisible(e)}setBeltsVisible(e){this.belt&&this.belt.setVisible(e),this.kuiper&&this.kuiper.setVisible(e&&(this.lastZoom??1)>.74),this.beltsEnabled=e}setPixelRatio(e){this.pixelRatio=e}dispose(){this.starfield?.dispose(),this.orbitLines?.dispose(),this.belt?.dispose(),this.kuiper?.dispose(),this.scene.remove(this.root)}},Wd={id:{title:`Tata Surya Interaktif`,subtitle:`Globe Bumi yang bisa ditarik mundur menjadi seluruh tata surya`,loading:`Menyiapkan tekstur`,loadingHint:`Menyiapkan globe Bumi`,scrollHint:`Gulir (scroll) untuk menjauh`,scrollHintDetail:`Perkecil Bumi perlahan sampai seluruh tata surya terlihat`,dragHint:`Seret untuk memutar`,clickHint:`Klik planet untuk mendekatinya`,levelTitle:`Skala pandang`,levelGlobe:`Permukaan planet`,levelOrbit:`Orbit planet`,levelInner:`Tata surya bagian dalam`,levelOuter:`Seluruh tata surya`,legendTitle:`Benda langit`,settingsTitle:`Pengaturan`,infoTitle:`Keterangan`,close:`Tutup`,speed:`Kecepatan waktu`,speedPaused:`Dijeda`,orbits:`Garis orbit`,labels:`Label nama`,belts:`Sabuk asteroid`,bloom:`Efek cahaya (bloom)`,autoRotate:`Putar otomatis`,quality:`Kualitas grafis`,language:`Bahasa`,qualityAuto:`Otomatis`,resetView:`Kembali ke Bumi`,resetDate:`Kembali ke hari ini`,simDate:`Tanggal simulasi`,pause:`Jeda`,play:`Jalankan`,credits:`Sumber tekstur`,creditsText:`Tekstur planet oleh Solar System Scope (CC BY 4.0). Bulan-bulan kecil digambar secara prosedural.`,keyboardHelp:`Gulir: zoom · Seret: putar · Klik planet: dekati · R: kembali ke Bumi · Spasi: jeda · O: garis orbit · L: label · H: sembunyikan antarmuka · 0-9: pilih benda langit`,webglError:`Peramban ini tidak dapat menjalankan WebGL, sehingga tata surya tidak dapat ditampilkan.`,webglErrorHint:`Coba peramban lain yang lebih baru, atau aktifkan akselerasi perangkat keras.`,units:{au:`SA`,days:`hari`}},en:{title:`Interactive Solar System`,subtitle:`An Earth globe you can pull back into the whole solar system`,loading:`Loading textures`,loadingHint:`Preparing the Earth globe`,scrollHint:`Scroll to zoom out`,scrollHintDetail:`Pull back from Earth until the whole solar system appears`,dragHint:`Drag to orbit`,clickHint:`Click a planet to fly to it`,levelTitle:`View scale`,levelGlobe:`Planet surface`,levelOrbit:`Planetary orbit`,levelInner:`Inner solar system`,levelOuter:`The whole solar system`,legendTitle:`Celestial bodies`,settingsTitle:`Settings`,infoTitle:`Details`,close:`Close`,speed:`Time speed`,speedPaused:`Paused`,orbits:`Orbit lines`,labels:`Name labels`,belts:`Asteroid belt`,bloom:`Glow (bloom)`,autoRotate:`Auto rotate`,quality:`Graphics quality`,language:`Language`,qualityAuto:`Automatic`,resetView:`Back to Earth`,resetDate:`Back to today`,simDate:`Simulated date`,pause:`Pause`,play:`Play`,credits:`Texture source`,creditsText:`Planet textures by Solar System Scope (CC BY 4.0). Small moons are drawn procedurally.`,keyboardHelp:`Scroll: zoom · Drag: orbit · Click a planet: fly to it · R: back to Earth · Space: pause · O: orbits · L: labels · H: hide UI · 0-9: select a body`,webglError:`This browser cannot run WebGL, so the solar system cannot be displayed.`,webglErrorHint:`Try a newer browser, or enable hardware acceleration.`,units:{au:`AU`,days:`days`}}},Gd={sun:{id:{tagline:`Bintang induk: 99,86% massa tata surya ada di sini.`,stats:[[`Diameter`,`1.392.700 km`],[`Suhu permukaan`,`5.500 °C`],[`Suhu inti`,`15.000.000 °C`],[`Umur`,`4,6 miliar tahun`]],facts:[`Setiap detiknya Matahari mengubah sekitar 600 juta ton hidrogen menjadi helium.`,`Cahaya Matahari butuh 8 menit 20 detik untuk sampai ke Bumi.`,`Permukaannya bukan padat: yang terlihat adalah plasma yang mendidih dan mengalir.`]},en:{tagline:`The host star: 99.86% of the solar system’s mass is here.`,stats:[[`Diameter`,`1,392,700 km`],[`Surface temperature`,`5,500 °C`],[`Core temperature`,`15,000,000 °C`],[`Age`,`4.6 billion years`]],facts:[`The Sun fuses about 600 million tonnes of hydrogen into helium every second.`,`Sunlight takes 8 minutes 20 seconds to reach Earth.`,`Its surface is not solid: what you see is boiling, flowing plasma.`]}},mercury:{id:{tagline:`Planet terkecil dan tercepat, tanpa atmosfer yang berarti.`,stats:[[`Jarak dari Matahari`,`0,39 SA`],[`Suhu`,`−173 °C sampai 427 °C`],[`Satu tahun`,`88 hari Bumi`],[`Satu hari`,`176 hari Bumi`]],facts:[`Perbedaan suhu siang dan malamnya paling ekstrem di antara semua planet.`,`Permukaannya penuh kawah dan hampir tidak berubah selama miliaran tahun.`,`Satu kali putaran pada porosnya hampir dua kali lebih lama daripada satu tahunnya.`]},en:{tagline:`The smallest and fastest planet, with almost no atmosphere.`,stats:[[`Distance from Sun`,`0.39 AU`],[`Temperature`,`−173 °C to 427 °C`],[`One year`,`88 Earth days`],[`One day`,`176 Earth days`]],facts:[`Its day-to-night temperature swing is the most extreme of any planet.`,`The surface is cratered and has barely changed in billions of years.`,`One spin on its axis takes nearly two of its years.`]}},venus:{id:{tagline:`Kembaran Bumi yang berubah menjadi rumah kaca terpanas.`,stats:[[`Jarak dari Matahari`,`0,72 SA`],[`Suhu permukaan`,`465 °C`],[`Tekanan permukaan`,`92 kali Bumi`],[`Satu tahun`,`225 hari Bumi`]],facts:[`Awan asam sulfatnya memantulkan cahaya, sehingga Venus tampak paling terang di langit malam.`,`Atmosfernya 96% karbon dioksida; efek rumah kacanya membuat Venus lebih panas daripada Merkurius.`,`Venus berputar mundur, dan satu hari di sana lebih lama daripada satu tahunnya.`]},en:{tagline:`Earth’s twin that turned into the hottest greenhouse world.`,stats:[[`Distance from Sun`,`0.72 AU`],[`Surface temperature`,`465 °C`],[`Surface pressure`,`92x Earth`],[`One year`,`225 Earth days`]],facts:[`Its sulphuric acid clouds reflect so much light that Venus is the brightest planet in our sky.`,`The atmosphere is 96% carbon dioxide, and its greenhouse effect makes it hotter than Mercury.`,`Venus spins backwards, and one day there lasts longer than its year.`]}},earth:{id:{tagline:`Satu-satunya tempat yang diketahui memiliki kehidupan.`,stats:[[`Jarak dari Matahari`,`1,00 SA`],[`Suhu rata-rata`,`15 °C`],[`Permukaan air`,`71%`],[`Satu tahun`,`365,25 hari`]],facts:[`Atmosfernya 78% nitrogen dan 21% oksigen — komposisi yang hanya mungkin dengan adanya kehidupan.`,`Sisi malam Bumi menunjukkan cahaya kota: pola permukiman manusia terlihat dari angkasa.`,`Bulan mengorbit pada jarak sekitar 384.400 km dan rotasinya terkunci, jadi satu sisi selalu menghadap Bumi.`]},en:{tagline:`The only place known to have life.`,stats:[[`Distance from Sun`,`1.00 AU`],[`Average temperature`,`15 °C`],[`Water surface`,`71%`],[`One year`,`365.25 days`]],facts:[`Its atmosphere is 78% nitrogen and 21% oxygen — a mix only possible with life.`,`The night side shows city lights: human settlement patterns are visible from space.`,`The Moon orbits at about 384,400 km with locked rotation, so the same face always points at Earth.`]}},moon:{id:{tagline:`Satelit alam terbesar kelima, dan satu-satunya yang pernah dikunjungi manusia.`,stats:[[`Jarak dari Bumi`,`384.400 km`],[`Diameter`,`3.475 km`],[`Satu orbit`,`27,3 hari`],[`Gravitasi`,`1/6 Bumi`]],facts:[`Sisi jauhnya baru bisa dilihat manusia setelah wahana antariksa memutari Bulan.`,`Pasang-surut laut di Bumi terutama digerakkan oleh gravitasi Bulan.`,`Karena rotasinya terkunci, dari Bumi kita selalu melihat sisi yang sama.`]},en:{tagline:`The fifth-largest natural satellite, and the only one humans have visited.`,stats:[[`Distance from Earth`,`384,400 km`],[`Diameter`,`3,475 km`],[`One orbit`,`27.3 days`],[`Gravity`,`1/6 of Earth`]],facts:[`No human saw the far side until spacecraft flew around it.`,`Ocean tides on Earth are driven mostly by the Moon’s gravity.`,`Because its rotation is locked, we only ever see one side from Earth.`]}},mars:{id:{tagline:`Planet merah, target utama eksplorasi berawak.`,stats:[[`Jarak dari Matahari`,`1,52 SA`],[`Suhu rata-rata`,`−63 °C`],[`Satu tahun`,`687 hari Bumi`],[`Jumlah bulan`,`2`]],facts:[`Warna merahnya berasal dari besi oksida — karat — pada debu permukaannya.`,`Olympus Mons adalah gunung tertinggi di tata surya, hampir tiga kali tinggi Everest.`,`Phobos mengorbit begitu cepat sehingga terbit dua kali dalam sehari Mars.`]},en:{tagline:`The red planet, primary target for crewed exploration.`,stats:[[`Distance from Sun`,`1.52 AU`],[`Average temperature`,`−63 °C`],[`One year`,`687 Earth days`],[`Moons`,`2`]],facts:[`Its red colour comes from iron oxide — rust — in the surface dust.`,`Olympus Mons is the tallest volcano in the solar system, nearly three times Everest.`,`Phobos orbits so fast that it rises twice in a single Martian day.`]}},jupiter:{id:{tagline:`Raksasa gas dengan massa lebih dari dua kali semua planet lain digabung.`,stats:[[`Jarak dari Matahari`,`5,20 SA`],[`Diameter`,`139.820 km`],[`Satu hari`,`9,9 jam`],[`Jumlah bulan`,`95+`]],facts:[`Bintik Merah Besar adalah badai yang sudah berlangsung lebih dari satu abad, dan bisa memuat satu Bumi.`,`Pitanya bukan permukaan: yang terlihat adalah puncak awan amonia yang bergerak dengan kecepatan berbeda.`,`Empat bulan terbesarnya — Io, Europa, Ganymede, Callisto — ditemukan Galileo pada 1610.`]},en:{tagline:`A gas giant more massive than twice all other planets combined.`,stats:[[`Distance from Sun`,`5.20 AU`],[`Diameter`,`139,820 km`],[`One day`,`9.9 hours`],[`Moons`,`95+`]],facts:[`The Great Red Spot is a storm that has raged for over a century and could swallow Earth.`,`Its bands are not a surface: you are seeing ammonia cloud tops moving at different speeds.`,`The four largest moons were found by Galileo in 1610.`]}},saturn:{id:{tagline:`Cincin paling megah, dan planet paling ringan.`,stats:[[`Jarak dari Matahari`,`9,54 SA`],[`Diameter`,`116.460 km`],[`Massa jenis`,`0,69 gram/cm³`],[`Jumlah bulan`,`146+`]],facts:[`Kepadatan Saturnus lebih kecil daripada air — secara teori ia bisa terapung.`,`Cincinnya terbentang 280.000 km tetapi rata-rata hanya belasan meter tebalnya.`,`Celah Cassini, yang terlihat jelas di antara cincin, lebarnya sekitar 4.800 km.`]},en:{tagline:`The grandest rings, and the lightest planet.`,stats:[[`Distance from Sun`,`9.54 AU`],[`Diameter`,`116,460 km`],[`Density`,`0.69 g/cm³`],[`Moons`,`146+`]],facts:[`Saturn is less dense than water — in theory it would float.`,`The rings span 280,000 km but average only tens of metres thick.`,`The Cassini Division is about 4,800 km wide.`]}},uranus:{id:{tagline:`Planet yang menggelinding: porosnya nyaris rebah.`,stats:[[`Jarak dari Matahari`,`19,19 SA`],[`Kemiringan poros`,`97,8°`],[`Suhu`,`−224 °C`],[`Satu tahun`,`84 tahun Bumi`]],facts:[`Uranus mengorbit sambil menggelinding, sehingga tiap kutub mengalami 42 tahun siang lalu 42 tahun malam.`,`Warna birunya berasal dari metana yang menyerap cahaya merah.`,`Ia planet pertama yang ditemukan lewat teleskop, pada tahun 1781.`]},en:{tagline:`The planet that rolls: its axis lies nearly on its side.`,stats:[[`Distance from Sun`,`19.19 AU`],[`Axial tilt`,`97.8°`],[`Temperature`,`−224 °C`],[`One year`,`84 Earth years`]],facts:[`Uranus rolls along its orbit, so each pole gets 42 years of daylight then 42 of darkness.`,`Its blue-green colour comes from methane absorbing red light.`,`It was the first planet found by telescope, in 1781.`]}},neptune:{id:{tagline:`Planet terjauh, dengan angin tercepat di tata surya.`,stats:[[`Jarak dari Matahari`,`30,07 SA`],[`Kecepatan angin`,`2.100 km/jam`],[`Satu tahun`,`165 tahun Bumi`],[`Jumlah bulan`,`16`]],facts:[`Neptunus ditemukan lewat perhitungan matematika sebelum benar-benar terlihat.`,`Angin di sana bisa mencapai 2.100 km/jam — tercepat di tata surya.`,`Triton, bulan terbesarnya, mengorbit mundur dan kemungkinan benda langit yang tertangkap.`]},en:{tagline:`The farthest planet, with the fastest winds in the solar system.`,stats:[[`Distance from Sun`,`30.07 AU`],[`Wind speed`,`2,100 km/h`],[`One year`,`165 Earth years`],[`Moons`,`16`]],facts:[`Neptune was found by mathematics before anyone saw it.`,`Winds there reach 2,100 km/h — the fastest in the solar system.`,`Triton orbits backwards and is probably a captured object.`]}}},Kd={io:{id:`Bulan paling aktif secara vulkanik di tata surya.`,en:`The most volcanically active body in the solar system.`},europa:{id:`Di bawah kerak esnya tersimpan samudra air asin.`,en:`A salty ocean hides beneath its icy crust.`},ganymede:{id:`Bulan terbesar di tata surya, lebih besar daripada Merkurius.`,en:`The largest moon in the solar system, bigger than Mercury.`},callisto:{id:`Permukaannya paling penuh kawah di tata surya.`,en:`The most heavily cratered surface in the solar system.`},titan:{id:`Punya atmosfer tebal dan danau metana cair.`,en:`It has a thick atmosphere and lakes of liquid methane.`},enceladus:{id:`Geyser di kutubnya menyemburkan air dari samudra bawah es.`,en:`Geysers at its pole spray water from a subsurface ocean.`},rhea:{id:`Bulan terbesar kedua Saturnus, hampir seluruhnya es.`,en:`Saturn’s second-largest moon, almost entirely ice.`},titania:{id:`Bulan terbesar Uranus, penuh lembah dan ngarai.`,en:`The largest moon of Uranus, scarred by valleys and canyons.`},oberon:{id:`Bulan terjauh Uranus, gelap dan penuh kawah tua.`,en:`The outermost major moon of Uranus, dark and heavily cratered.`},triton:{id:`Mengorbit mundur dan punya geyser nitrogen.`,en:`It orbits backwards and has nitrogen geysers.`},phobos:{id:`Bentuknya seperti kentang dan perlahan jatuh ke Mars.`,en:`Potato-shaped, and slowly spiralling into Mars.`},deimos:{id:`Bulan kecil Mars, lebarnya hanya sekitar 12 km.`,en:`A tiny moon of Mars, only about 12 km across.`}};function qd(e,t=`id`){return e.kind===`moon`?{tagline:Kd[e.id]?.[t]??``,stats:[[`Diameter`,`${(e.radiusKm*2).toLocaleString(`id-ID`)} km`],[t===`id`?`Periode orbit`:`Orbital period`,`${Math.abs(e.periodDays??0).toFixed(2)} ${Wd[t].units.days}`],[t===`id`?`Rotasi`:`Rotation`,e.tidallyLocked?t===`id`?`Terkunci pasang-surut`:`Tidally locked`:`${Math.abs(e.rotationHours??0).toFixed(1)} jam`]],facts:[]}:Gd[e.id]?.[t]??{tagline:``,stats:[],facts:[]}}function $(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n!=null&&(r.textContent=n),r}var Jd=class{constructor(e){this.options=e,this.language=`id`,this.root=document.getElementById(`ui`),this.text=Wd[this.language],this.#e(),this.#t(),this.#n(),this.#r(),this.#i(),this.#c(),this.#l(),this.hintUsed=!1,this.activeBodyId=null}#e(){let e=$(`div`,`loader`);e.id=`loader`;let t=$(`div`,`loader__card`);t.appendChild($(`div`,`loader__globe`)),t.appendChild($(`h1`,`loader__title`,this.text.title)),t.appendChild($(`p`,`loader__hint`,this.text.loadingHint));let n=$(`div`,`loader__bar`);this.loaderFill=$(`div`,`loader__fill`),n.appendChild(this.loaderFill),t.appendChild(n),this.loaderLabel=$(`div`,`loader__label`,`${this.text.loading}…`),t.appendChild(this.loaderLabel),e.appendChild(t),this.root.appendChild(e),this.loader=e}setProgress(e){let t=Math.round(Math.max(0,Math.min(1,e))*100);this.loaderFill.style.width=`${t}%`,this.loaderLabel.textContent=`${this.text.loading}… ${t}%`}hideLoader(){this.loader.classList.add(`is-hidden`),window.setTimeout(()=>this.loader.remove(),900)}#t(){let e=$(`header`,`topbar`),t=$(`div`,`topbar__left`);this.titleNode=$(`div`,`topbar__title`,this.text.title),this.subtitleNode=$(`div`,`topbar__subtitle`,this.text.subtitle),t.appendChild(this.titleNode),t.appendChild(this.subtitleNode);let n=$(`div`,`topbar__right`);this.dateNode=$(`div`,`topbar__date`),n.appendChild(this.dateNode),this.homeButton=$(`button`,`button button--ghost`,this.text.resetView),this.homeButton.type=`button`,this.homeButton.addEventListener(`click`,()=>this.options.onSelectBody(`earth`)),n.appendChild(this.homeButton),e.appendChild(t),e.appendChild(n),this.root.appendChild(e),this.topBar=e}setSimDate(e,t){let n=new Intl.DateTimeFormat(this.language===`id`?`id-ID`:`en-GB`,{dateStyle:`medium`,timeStyle:`short`,timeZone:`UTC`}).format(e),r=t?` · ${this.text.speedPaused}`:``;this.dateNode.textContent=`${this.text.simDate}: ${n} UTC${r}`}#n(){let e=$(`div`,`scalebar`);e.appendChild($(`div`,`scalebar__title`,this.text.levelTitle)),this.scaleLabel=$(`div`,`scalebar__label`),e.appendChild(this.scaleLabel);let t=$(`div`,`scalebar__track`);this.scaleFill=$(`div`,`scalebar__fill`),this.scaleThumb=$(`div`,`scalebar__thumb`),t.appendChild(this.scaleFill),t.appendChild(this.scaleThumb),this.scaleSteps=[{z:0,key:`levelGlobe`},{z:.28,key:`levelOrbit`},{z:.62,key:`levelInner`},{z:1,key:`levelOuter`}].map(e=>{let n=$(`button`,`scalebar__step`);return n.type=`button`,n.title=this.text[e.key],n.addEventListener(`click`,()=>this.options.onJumpToScale(e.z)),t.appendChild(n),{...e,dot:n}}),e.appendChild(t),this.root.appendChild(e),this.scaleBar=e}setZoomState(e){let t=Math.max(0,Math.min(1,e));this.scaleFill.style.height=`${(t*100).toFixed(1)}%`,this.scaleThumb.style.bottom=`${(t*100).toFixed(1)}%`;let n=`levelGlobe`;t>.78?n=`levelOuter`:t>.5?n=`levelInner`:t>.2&&(n=`levelOrbit`),this.scaleLabel.textContent=this.text[n]}#r(){let e=$(`nav`,`legend`);e.appendChild($(`div`,`legend__title`,this.text.legendTitle));let t=$(`div`,`legend__list`);this.legendButtons=new Map;for(let e of this.options.bodies){let n=$(`button`,`legend__item`);n.type=`button`,n.dataset.bodyId=e.id;let r=`#${(e.def.color??9082029).toString(16).padStart(6,`0`)}`;n.style.setProperty(`--dot`,r);let i=$(`span`,`legend__dot`);i.style.background=r;let a=$(`span`,`legend__name`,e.name[this.language]??e.name.id);n.appendChild(i),n.appendChild(a),n.addEventListener(`click`,()=>this.options.onSelectBody(e.id)),t.appendChild(n),this.legendButtons.set(e.id,{button:n,label:a,entry:e})}e.appendChild(t),this.root.appendChild(e),this.legend=e}setActiveBody(e){this.activeBodyId=e;for(let[t,n]of this.legendButtons)n.button.classList.toggle(`is-active`,t===e)}#i(){let e=$(`aside`,`info`);e.id=`info`;let t=$(`div`,`info__head`);this.infoTitle=$(`h2`,`info__title`),this.infoTagline=$(`p`,`info__tagline`);let n=$(`button`,`info__close`,`×`);n.type=`button`,n.setAttribute(`aria-label`,this.text.close),n.addEventListener(`click`,()=>this.hideInfo()),t.appendChild(this.infoTitle),t.appendChild(n),e.appendChild(t),e.appendChild(this.infoTagline),this.infoStats=$(`dl`,`info__stats`),e.appendChild(this.infoStats),this.infoFacts=$(`ul`,`info__facts`),e.appendChild(this.infoFacts),this.root.appendChild(e),this.infoPanel=e}showInfo(e){let t=qd(e,this.language),n=`#${(e.color??9082029).toString(16).padStart(6,`0`)}`;this.infoTitle.textContent=e.name[this.language]??e.name.id,this.infoTitle.style.setProperty(`--accent`,n),this.infoTagline.textContent=t.tagline,this.infoStats.replaceChildren();for(let[e,n]of t.stats)this.infoStats.appendChild($(`dt`,`info__stat-key`,e)),this.infoStats.appendChild($(`dd`,`info__stat-value`,n));this.infoFacts.replaceChildren();for(let e of t.facts)this.infoFacts.appendChild($(`li`,`info__fact`,e));this.infoPanel.classList.add(`is-visible`)}hideInfo(){this.infoPanel.classList.remove(`is-visible`)}#a(e,t){let n=$(`label`,`settings__row`);return n.appendChild($(`span`,`settings__label`,e)),n.appendChild(t),n}#o(e,t,n){let r=$(`input`);r.type=`checkbox`,r.checked=t,r.addEventListener(`change`,()=>n(r.checked));let i=$(`span`,`settings__check`);return i.appendChild(r),{row:this.#a(e,i),input:r}}#s(e,t,n){for(let[r,i]of t){let t=$(`option`,null,i);t.value=r,t.selected=r===n,e.appendChild(t)}return e}#c(){let e=$(`section`,`settings`);e.id=`settings`;let t=$(`button`,`settings__toggle`,`⚙`);t.type=`button`,t.setAttribute(`aria-label`,this.text.settingsTitle),t.addEventListener(`click`,()=>e.classList.toggle(`is-open`)),e.appendChild(t);let n=$(`div`,`settings__body`);n.appendChild($(`h2`,`settings__title`,this.text.settingsTitle)),this.speedSelect=this.#s($(`select`,`settings__select`),yu.map(e=>[String(e.daysPerSecond),e.label]),`0.1`),this.speedSelect.addEventListener(`change`,()=>this.options.onSettingChange(`speed`,Number(this.speedSelect.value))),n.appendChild(this.#a(this.text.speed,this.speedSelect)),this.paused=!1,this.pauseButton=$(`button`,`button button--tiny`,this.text.pause),this.pauseButton.type=`button`,this.pauseButton.addEventListener(`click`,()=>{this.paused=!this.paused,this.pauseButton.textContent=this.paused?this.text.play:this.text.pause,this.options.onSettingChange(`paused`,this.paused)}),n.appendChild(this.#a(`⏯`,this.pauseButton)),this.toggles={};for(let[e,t,r,i]of[[`orbits`,this.text.orbits,!0,`orbits`],[`labels`,this.text.labels,!0,`labels`],[`belts`,this.text.belts,!0,`belts`],[`bloom`,this.text.bloom,!0,`bloom`],[`autoRotate`,this.text.autoRotate,!1,`autoRotate`]]){let{row:a,input:o}=this.#o(t,r,e=>this.options.onSettingChange(i,e));this.toggles[e]=o,n.appendChild(a)}this.qualitySelect=this.#s($(`select`,`settings__select`),[[`auto`,this.text.qualityAuto],[`low`,`Rendah / Low`],[`medium`,`Sedang / Medium`],[`high`,`Tinggi / High`]],`auto`),this.qualitySelect.addEventListener(`change`,()=>this.options.onSettingChange(`quality`,this.qualitySelect.value)),n.appendChild(this.#a(this.text.quality,this.qualitySelect)),this.languageSelect=this.#s($(`select`,`settings__select`),[[`id`,`Bahasa Indonesia`],[`en`,`English`]],`id`),this.languageSelect.addEventListener(`change`,()=>this.setLanguage(this.languageSelect.value)),n.appendChild(this.#a(this.text.language,this.languageSelect));let r=$(`button`,`button button--tiny`,this.text.resetDate);r.type=`button`,r.addEventListener(`click`,()=>this.options.onSettingChange(`resetDate`,!0)),n.appendChild(this.#a(`⟲`,r)),n.appendChild($(`p`,`settings__help`,this.text.keyboardHelp)),e.appendChild(n),this.root.appendChild(e),this.settingsPanel=e}setToggle(e,t){this.toggles?.[e]&&(this.toggles[e].checked=t)}showHint(e){let t=$(`div`,`hint`);t.appendChild($(`div`,`hint__main`,this.text.scrollHint)),t.appendChild($(`div`,`hint__sub`,this.text.scrollHintDetail)),t.appendChild($(`div`,`hint__keys`,`${this.text.dragHint} · ${this.text.clickHint}`)),this.root.appendChild(t),this.hint=t;let n=()=>{this.hintUsed||(this.hintUsed=!0,t.classList.add(`is-hidden`),window.removeEventListener(`wheel`,n),window.removeEventListener(`pointerdown`,n),window.setTimeout(()=>t.remove(),700),e?.())};window.addEventListener(`wheel`,n,{passive:!0}),window.addEventListener(`pointerdown`,n),this.hintDismiss=n}#l(){let e=$(`footer`,`credits`);this.creditsLabel=$(`span`,`credits__label`,`${this.text.credits}: `),this.creditsText=$(`span`,`credits__text`,this.text.creditsText),e.appendChild(this.creditsLabel),e.appendChild(this.creditsText),this.root.appendChild(e),this.credits=e}showWebGLError(){let e=$(`div`,`error`);e.appendChild($(`h2`,`error__title`,this.text.webglError)),e.appendChild($(`p`,`error__hint`,this.text.webglErrorHint)),this.root.appendChild(e),this.loader?.classList.add(`is-hidden`)}setInterfaceVisible(e){this.root.classList.toggle(`is-hidden`,!e)}setLanguage(e){this.language=e,this.text=Wd[e],document.documentElement.lang=e,this.titleNode.textContent=this.text.title,this.subtitleNode.textContent=this.text.subtitle,this.homeButton.textContent=this.text.resetView,this.scaleBar.querySelector(`.scalebar__title`).textContent=this.text.levelTitle,this.legend.querySelector(`.legend__title`).textContent=this.text.legendTitle,this.settingsPanel.querySelector(`.settings__title`).textContent=this.text.settingsTitle,this.settingsPanel.querySelector(`.settings__help`).textContent=this.text.keyboardHelp,this.creditsLabel.textContent=`${this.text.credits}: `,this.creditsText.textContent=this.text.creditsText,this.pauseButton.textContent=this.paused?this.text.play:this.text.pause;for(let[,t]of this.legendButtons)t.label.textContent=t.entry.name[e]??t.entry.name.id;for(let e of this.scaleSteps)e.dot.title=this.text[e.key];if(this.activeBodyId&&this.infoPanel.classList.contains(`is-visible`)){let e=this.legendButtons.get(this.activeBodyId);e&&this.showInfo(e.entry.def)}this.options.onLanguageChange?.(e)}syncLabels(e){e?.setLanguage(this.language)}},Yd=[Mu.id,...Nu.map(e=>e.id)];async function Xd(){let e=document.getElementById(`canvas`),t=document.getElementById(`labels`),n=[Mu,...Nu].map(e=>({id:e.id,name:e.name,def:e,kind:e.kind===`star`?`star`:`planet`})),r={uiHidden:!1,clock:new bu(new Date),pointer:new W,raycaster:new oo,fpsSamples:[],lastQualityCheck:0},i=new Jd({bodies:n,onSelectBody:e=>_(e,!0),onJumpToScale:e=>{i.hintDismiss?.(),p.setZoom(e)},onSettingChange:(e,t)=>y(e,t),onLanguageChange:e=>{i.syncLabels(g)}}),a;try{a=Tu(e)}catch(e){console.error(`[hermes] WebGL tidak tersedia:`,e),i.showWebGLError();return}let o=new La(52,window.innerWidth/Math.max(window.innerHeight,1),.05,2e3),s=new Mn,c=Su(a),l=!0,u=structuredClone(xu[c]);Eu(a,c),u.heroTextures=wu(a,xu[c])&&c===`high`;let d=new Ml({baseUrl:`./`,anisotropy:u.anisotropy,onProgress:e=>i.setProgress(e.loaded/Math.max(e.total,1)*.92)}),f=new Ud({assets:d,preset:u,scene:s,startDate:r.clock.startDate});await f.init(e=>i.setProgress(.92+e.loaded*.08)),f.setPixelRatio(a.getPixelRatio());let p=new ql(o,e),m=f.getBody(`earth`);p.setFocus(m||f.sun,{zoom:0});let h=new cu(a,s,o,{bloom:u.bloom,strength:.62,radius:.45,threshold:.72}),g=new Ru(t,[Mu,...Nu].map(e=>({id:e.id,name:e.name,body:f.getBody(e.id),kind:e.kind===`star`?`star`:`planet`})));window.__hermesDebug={setZoom:e=>p.debugSetZoom(e),focus:e=>_(e,!0),state:()=>({zoom:p.zoom,focusId:p.focus?.id})};function _(e,t=!1){let n=f.getBody(e);if(n&&(p.setFocus(n,{zoom:0}),i.setActiveBody(e),i.hintDismiss?.(),t)){let t=e===Mu.id?Mu:n.def;i.showInfo(t)}}r.selectBody=_;let v=null;e.addEventListener(`pointerdown`,e=>{v={x:e.clientX,y:e.clientY}}),e.addEventListener(`pointerup`,t=>{if(!v)return;let n=Math.hypot(t.clientX-v.x,t.clientY-v.y);if(v=null,n>6)return;let i=e.getBoundingClientRect();r.pointer.set((t.clientX-i.left)/i.width*2-1,-((t.clientY-i.top)/i.height)*2+1),r.raycaster.setFromCamera(r.pointer,o);let a=r.raycaster.intersectObjects(f.pickables,!1);if(a.length>0){let e=a[0].object.userData.body;e&&_(e.id??e,!0)}});function y(e,t){let n=r.clock;switch(e){case`speed`:n.setSpeed(t);break;case`paused`:n.paused=t;break;case`orbits`:f.setOrbitsVisible(t);break;case`labels`:g.setEnabled(t);break;case`belts`:f.setBeltsVisible(t);break;case`bloom`:h.setBloomEnabled(t);break;case`autoRotate`:p.autoRotate=t;break;case`resetDate`:n.reset();break;case`quality`:t===`auto`?(l=!0,c=Su(a)):(l=!1,c=t),b()}}function b(){Eu(a,c);let e=xu[c].bloom;h.setBloomEnabled(e),i.setToggle(`bloom`,e),d.applyAnisotropy(xu[c].anisotropy),f.setPixelRatio(a.getPixelRatio()),h.setSize(window.innerWidth,window.innerHeight)}function x(e){if(!l||e-r.lastQualityCheck<4e3)return;r.lastQualityCheck=e;let t=r.fpsSamples;if(t.length<30)return;let n=t.reduce((e,t)=>e+t,0)/t.length;r.fpsSamples=[];let i=Cu(c,n);i!==c&&(c=i,b(),console.info(`[hermes] kualitas diturunkan otomatis ke ${c} (rata-rata ${n.toFixed(0)} fps)`))}window.addEventListener(`keydown`,e=>{if(!(e.target instanceof HTMLInputElement||e.target instanceof HTMLSelectElement))switch(e.key){case` `:e.preventDefault(),i.paused=!i.paused,i.pauseButton.textContent=i.paused?i.text.play:i.text.pause,y(`paused`,i.paused);break;case`r`:case`R`:_(`earth`,!0);break;case`o`:case`O`:i.setToggle(`orbits`,!i.toggles.orbits.checked),y(`orbits`,i.toggles.orbits.checked);break;case`l`:case`L`:i.setToggle(`labels`,!i.toggles.labels.checked),y(`labels`,i.toggles.labels.checked);break;case`h`:case`H`:r.uiHidden=!r.uiHidden,i.setInterfaceVisible(!r.uiHidden);break;case`ArrowUp`:p.rotate(0,-.06);break;case`ArrowDown`:p.rotate(0,.06);break;case`ArrowLeft`:p.rotate(-.06,0);break;case`ArrowRight`:p.rotate(.06,0);break;case`+`:case`=`:p.zoomBy(-.05);break;case`-`:case`_`:p.zoomBy(.05);break;default:{let t=Number.parseInt(e.key,10);!Number.isNaN(t)&&t>=0&&t<Yd.length&&_(Yd[t],!0);break}}}),t.addEventListener(`click`,e=>{let t=e.target.closest(`[data-body-id]`);t?.dataset.bodyId&&_(t.dataset.bodyId,!0)}),Du(a,o,(e,t)=>h.setSize(e,t)),i.hideLoader(),i.setZoomState(p.zoom),i.setActiveBody(`earth`),i.setSimDate(r.clock.date,r.clock.paused),i.showInfo(f.getBody(`earth`).def),i.showHint(()=>{});let S=performance.now();a.setAnimationLoop(e=>{let t=Math.min((e-S)/1e3,.1);S=e,t>0&&r.fpsSamples.push(1/t),r.fpsSamples.length>240&&r.fpsSamples.shift(),x(e),r.clock.update(t),f.update(t,r.clock,o,p.zoom),p.update(t),f.lastZoom=p.zoom,g.update(o,{zoom:p.zoom,focusId:p.focus?.id}),i.setZoomState(p.zoom),!i.paused!=!r.clock.paused&&(i.paused=r.clock.paused,i.pauseButton.textContent=r.clock.paused?i.text.play:i.text.pause),i.setSimDate(r.clock.date,r.clock.paused),h.render(t)})}Xd().catch(e=>{console.error(`[hermes] gagal dijalankan:`,e);let t=document.querySelector(`.loader__label`);t&&(t.textContent=`Gagal memuat: ${e?.message??e}`)});